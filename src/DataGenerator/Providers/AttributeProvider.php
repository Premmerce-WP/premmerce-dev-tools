...
class AttributeProvider extends Base
{
    private $electronicAttributes = [
        ...
        'Solid-State Drive Capacity'             => '{{powTwo}} {{ciPrefix}}B',
        ...
        'Number of Pieces in Set'                => '{{intSize}} Pieces',
        ...
        'Home Automation Protocol Compatibility' => '{{prefixLight}}{{connectionType}} {{suffix}}',
        'Home Automation Gateway Compatibility'  => '{{prefixLight}}{{connectionType}} {{suffix}}',
        'Interface'                              => '{{prefixLight}}{{connectionType}} {{suffix}}',
        'Router Connectivity Type'               => '{{prefixLight}}{{connectionType}} {{suffix}}',
        ...
        'Motherboard Memory Technology'          => 'DDR{{versionNum}} {{suffix}}',
        'Motherboard Form Factor'                => '{{prefix}} ATX {{suffix}}',
        ...
        'Cookware Set Piece Count'               => '{{intSize}}}',
